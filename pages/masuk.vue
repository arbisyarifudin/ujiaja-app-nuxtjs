    ...
    <ContentWrapper>
              ...
              <div class="kanan mx-5 my-5">
                ...
                <form action="" class="form-user" @submit.prevent="validateForm">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control pl-0" id="username" placeholder="Email/Username terdaftar"
                      autocomplete="false" v-model="form.username" />
      ...
      showPassword ? 'fa-eye-slash' : 'fa-eye',
                  ...
                  <div class="form-group d-flex justify-content-between">
                    <label><a href="/lupa-password" class="lupa">Lupa Password?</a></label>
