              ...
              <div class="form-user mt-3">
                <!-- <div class="form-group reg-siswa">
                  <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    target="_blank"
                      v-if="dataDetail && form.file_kursus"
                      :href="ApiUrl(form.file_kursus)"
                      >Lihat File Lama</a
                    >
                  </div>
                ...
                <div class="form-group reg-siswa">
                  <label for="file_kursus"
                    >ID Video Youtube <code>[opsional]</code></label
                  >
...
export default {
  ...
  async created() {
    ...
    this.getPriceOption();
    await this.getAPI("provinsi");
    this.form.id_provinsi = parseInt(this.dataDetail.id_provinsi)
    this.form.id_kota = parseInt(this.dataDetail.id_kota)
    this.form.id_kecamatan = parseInt(this.dataDetail.id_kecamatan)
    this.dataOption['kota_kabupaten'] = [
      {
        id: parseInt(this.dataDetail.id_kota),
        nama: this.dataDetail.nama_kota
      }
    ]
    this.dataOption['kecamatan'] = [
      {
        id: parseInt(this.dataDetail.id_kecamatan),
        nama: this.dataDetail.nama_kecamatan
      }
    ]
  },
  methods: {
    ...
    submitData(type) {
      ...
      this.$axios
        .$put(`/api/kursus/update/${this.$route.params.id}`, dataCreate)
        .then(res => {
          console.log(res);
          if (res.success) {
