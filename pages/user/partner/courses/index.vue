    ...
    <div class="row d-flex no-gutters">
        ...
        <div class="row mt-5" v-if="totalRows > 0">
          ...
          >
            <div class="card card-karir m-2 router-push"
              @click="$router.push(`/user/partner/courses/${item.id}/detail?ref=${$route.path}`)">
              ...
              <div class="card-body text-left p-0">
                ...
                >
                  <nuxt-link
                    :to="`/user/partner/courses/${item.id}/detail?ref=${$route.path}`"
                    class="karir-link"
      ...
      >
        <div class="col-md-8">
          ...
          <nuxt-link class="btn btn-primary dashboard px-4" to="/user/partner/courses/add">
            Buat Kelas
          </nuxt-link>
        </div>
      </div>
