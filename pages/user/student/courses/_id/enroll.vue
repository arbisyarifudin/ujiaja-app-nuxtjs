    ...
    <div class="col-md-12 dash-kelas p-0 text-left">
      <div class="col-md-12 dash-kelas mandiri-detail p-0">
        <h2 class="pb-0 mb-5">
          <BackUrl
            :title="null"
            :url="`/user/student/${dataDetail.id}/detail`"
            ...
            <div class="row flex-wrap">
              <div class="col-md-12 mb-4">
                ...
                <div class="bg-white p-4 mr-2 mt-3" style="min-height: 200px">
                  <h5>{{ dataDetail.nama_kursus }}</h5>
                  <p class="mb-2 mt-3">Harga Kelas</p>
                  <h5 class="mb-0 text-primary">
                    Rp {{ dataDetail.harga_kursus_label }}
                  </h5>
                </div>
              </div>
              <div class="col-md-12 mb-4">
      ...
      <div class="bg-white py-4 px-5 " style="border-radius: 15px;">
        ...
        >
          ...
          <div class="col-md-6 p-0 text-right">
            <p class="m-0">{{ dataDetail.harga_kursus_label }}</p>
...
export default {
  ...
  mounted() {
    ...
    if (!this.$route.params.id)
      return this.$router.push("/user/student/courses/mine");
      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (res.success) {
            ...
            this.hargaProduk = this.dataDetail.harga_kursus;
