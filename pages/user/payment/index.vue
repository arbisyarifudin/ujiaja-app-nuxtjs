  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        ...
        <p>
          Data ini berisi transaksi dari pembayaran yang dilakukan oleh Anda.
        </p>
      </div>
            ...
            <div class="modal-body-kanan">
              <div class="card-image" v-show="showBukti || form.status != 'Menunggu Verifikasi'">
                ...
                <div class="mt-4">
                  <div class="mb-3">
                    <p class="mb-2">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores corrupti in quod odio similique nostrum, doloremque perferendis at doloribus quam aliquam illum quisquam, laboriosam necessitatibus quibusdam numquam est a accusantium?
                    </p>
