    ...
    <div class="text-left">
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <router-link
            to="/user/tryout/search?category=UTBK&package=Reguler&event=Perorangan"
            class="text-primary"
        ...
        <p>
          Ayo ikuti Tryout UTBK Mandiri yang tersedia dari Uji Aja dan belajar
          dari kumpulan soal serta pembahasan sebelumnya dengan membeli tryout!
        </p>
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <router-link
            to="/user/tryout/search?category=UTBK&package=Reguler&event=Masal"
            class="text-primary"
            >Lihat Semua</router-link
          >
        </div>
        ...
        <p>
          Ayo ikuti simulasi tryout UTBK yang berisi soal terbaik dari Uji Aja!
        </p>
            ...
            <div class="card card-karir m-2 router-push" @click="$router.push(`/user/tryout/${item.id}/detail`)">
              ...
              <div class="card-body text-left p-0">
                ...
                >
                  ...
                  ></nuxt-link>
                  <div class="icon-footer center">
                    <h4 class="title small">TRYOUT AKBAR</h4>
                    <h5 class="subtitle">
                      <span>{{ item.kategori_produk }}</span
                      ><span v-if="item.jenis_tryout">{{
                        item.jenis_tryout[0]
                      }}</span>
                    </h5>
                    <!-- <div>2021</div> -->
      ...
      <section class="mb-3">
        ...
        <p>
          Ayo ikuti Tryout Seleksi Mandiri yang tersedia dari Uji Aja dan belajar
          dari kumpulan soal serta pembahasan sebelumnya dengan membeli tryout!
        </p>
        ...
        <UITableNotFound
          ...
          text="Belum ada data Tryout."
          style="position: relative; width: 100%;"
          v-if="!loading && list['sm'] && list['sm'].length < 1"
        />
      </section>
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <router-link
            to="/user/tryout/search?category=ASPD&package=&event="
            class="text-primary"
            >Lihat Semua</router-link
          >
        </div>
        ...
        <p>
          Ayo ikuti Tryout ASPD yang tersedia dari Uji Aja dan belajar dari
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <router-link
            to="/user/tryout/search?category=PAT&package=&event="
            class="text-primary"
            >Lihat Semua</router-link
          >
        </div>
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          ...
          <router-link
            to="/user/tryout/search?category=PAS&package=&event="
            class="text-primary"
            >Lihat Semua</router-link
          >
        </div>
      ...
      <section class="mb-3">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h5 class="info-kelas">Paket Tryout</h5>
          <router-link
            to="/user/tryout/search?category=&package=Bundling&event="
            class="text-primary"
            >Lihat Semua</router-link
          >
        </div>
        ...
        <p>
          Beli paket favoritmu dengan harga yang lebih hemat!
        </p>
