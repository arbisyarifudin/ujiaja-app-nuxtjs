    ...
    <div class="col-md-12 dash-kelas p-0 text-left">
      <div class="col-md-12 dash-kelas mandiri-detail p-0">
        <h2 class="pb-0 mb-5">
          <BackUrl
            :title="null"
            :url="`/user/bundling/${dataDetail.id}/detail`"
            ...
            <div class="row flex-wrap">
              <div class="col-md-12 mb-4">
                ...
                <div class="bg-white p-4 mr-2 mt-3" style="min-height: 200px">
                  ...
                  <p class="mb-2 mt-3">Harga Materi</p>
...
export default {
  ...
  mounted() {
    ...
    if (!this.$route.params.id)
      return this.$router.push("/user/material");
