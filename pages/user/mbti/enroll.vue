          ...
          <div class="col-md-6 mb-4">
            <div class="row flex-wrap">
              <div class="col-md-12 mb-4">
                <h5>Pesanan</h5>
                <div class="bg-white p-4 mr-2 mt-3">
                  <h5 class="mb-3"><i class="fas fa-clipboard mr-1"></i> {{ dataDetail.judul }}</h5>
                  <p v-text="dataDetail.deskripsi" class="alert small alert-light border-1" style="min-height: 100px"></p>
                  <!-- <p class="mb-2 mt-3">Harga Tes MBTI</p>
      ...
      <div class="bg-white py-4 px-5 " style="border-radius: 15px;">
        ...
        >
          ...
          <div class="col-md-6 p-0 text-right">
            <p class="m-0">{{ dataDetail.harga }}</p>
      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (res.success) {
            ...
            this.hargaProduk = this.dataDetail.harga;
        ...
        .catch(() => {
          // console.log(err);
          return this.$router.push("/user/mbti");
          // this.catchError(err);
        })
