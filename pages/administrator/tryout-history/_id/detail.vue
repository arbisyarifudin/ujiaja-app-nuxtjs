  ...
  <div class="container-fluid crud px-md-4 px-0 py-4 bg-white">
    <div class="dash-kelas p-0 text-left">
      <h3>
        <BackUrl
          :title="null"
          :url="$route.query.ref ? $route.query.ref : `/administrator/tryout-history`"
    ...
    <div class="hasil mt-4" v-if="!loading">
      ...
      <div class="d-flex justify-content-end" style="position: relative; z-index: 9999">
        <button
        ...
        <nuxt-link class="btn btn-outline-primary square ml-3" :to="{
          path: `/administrator/tryout-history/${dataResult.detail.referensi}/answer`,
          query: {
