  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        <h2 class="dash-label">Rumpun</h2>
        <p>
          Data ini berisi Rumpun Ilmu.
        </p>
      </div>
                ...
                <tr v-for="(item, index) in items" :key="index">
                  ...
                  <td class="btn-table">
                    ...
                    <button
                      ...
                      "
                      v-if="isHavePermission('Rumpun', 'Delete')"
                    >
                      <i class="fa fa-trash"></i>
                    </button>
                    <span v-if="!isHavePermission('Rumpun', 'Edit') && !isHavePermission('Rumpun', 'Delete')">-</span>
                  </td>
                </tr>
              </template>
      ...
      >
        ...
        <p class="kosong-subtitle">Belum ada rumpun</p>
        <nuxt-link
    ...
    >
      <div>
        <p class="modal-text">Apakah anda yakin ingin menghapus rumpun ini?</p>
        <div class="modal-footer justify-content-end" style="border: 0px">
          ...
          <button
            ...
            type="button"
            :disabled="loading"
            @click.prevent="deleteData('rumpun')"
          >
