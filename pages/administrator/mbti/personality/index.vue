  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        <h2 class="dash-label">Kepribadian</h2>
        <p>
          Data ini berisi data kepribadian dari dimensi sifat dasar manusia.
          Data ini merupakan data master yang dibutuhkan untuk transaksi data
          modul MBTI.
        </p>
      </div>
            ...
            <tbody class="body-table">
              <template v-if="totalRows > 0">
                <tr v-for="(item, index) in items" :key="index">
                  ...
                  <td>{{ item.nama_singkat }} ({{ item.nama_panjang }})</td>
                  <td>{{ item.jenis }}</td>
                  <td>{{ item.partner }}</td>
                  <td class="btn-table">
                    <nuxt-link
      ...
      >
        ...
        <p class="kosong-subtitle">Belum ada kepribadian</p>
        <nuxt-link
    ...
    >
      <div>
        <p class="modal-text">
          Apakah anda yakin ingin menghapus data kepribadian ini?
        </p>
        <div class="modal-footer justify-content-end" style="border: 0px">
          ...
          <button
            ...
            type="button"
            :disabled="loading"
            @click.prevent="deleteData('kepribadian')"
          >
