  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        <h2 class="dash-label">Klaster</h2>
        <p>
          Data ini berisi klaster pada setiap klaster ilmu. Data ini merupakan
          data master yang dibutuhkan untuk pengkategorian rumpun.
        </p>
      </div>
                ...
                <tr v-for="(item, index) in items" :key="index">
                  ...
                  <td class="btn-table">
                    ...
                    <button
                      ...
                      "
                      v-if="isHavePermission('Klaster', 'Delete')"
                    >
                      <i class="fa fa-trash"></i>
                    </button>
                    <span
                      v-if="
                        !isHavePermission('Klaster', 'Edit') &&
                          !isHavePermission('Klaster', 'Delete')
                      "
                      >-</span
                    >
                  </td>
                  ...
                  <!-- <td>
                    ...
                    <span
                      ...
                      v-text="' - ' + item.kategori.kelompok"
                    ></span>
                    <span
                      v-if="item.kategori.jenjang"
                      v-text="' - ' + item.kategori.jenjang"
                    ></span>
                    <span
                      v-if="item.kategori.penjurusan"
                      v-text="' - ' + item.kategori.penjurusan"
                    ></span>
                    <span
      ...
      >
        ...
        <p class="kosong-subtitle">Belum ada klaster</p>
        <nuxt-link
    ...
    >
      <div>
        <p class="modal-text">Apakah anda yakin ingin menghapus klaster ini?</p>
        <div class="modal-footer justify-content-end" style="border: 0px">
          ...
          <button
            ...
            type="button"
            :disabled="loading"
            @click.prevent="deleteData('klaster')"
          >
      ...
      this.$axios
        ...
        .then(res => {
          ...
          if (res.success) {
            ...
            this.mapelKodes = res.mapel.map(item => item.kode);
          }
          return true;
        })
        .catch(err => {
