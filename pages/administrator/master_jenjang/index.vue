  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        <h2 class="dash-label">Jenjang</h2>
        <p>
          Data ini berisi daftar jenjang pendidikan. Data ini merupakan data
          master yang dibutuhkan untuk transaksi data sekolah dan perguruan
          tinggi.
        </p>
      </div>
        ...
        <div class="row no-gutters justify-content-between">
          ...
          <div class="col-md-5 d-flex align-items-center crud-tools">
            ...
            <nuxt-link
              ...
              to="/administrator/master_jenjang/add"
            >
              Tambah
            </nuxt-link>
          </div>
      ...
      >
        ...
        <p class="kosong-subtitle">Belum ada jenjang</p>
        <nuxt-link
    ...
    >
      <div>
        <p class="modal-text">
          Apakah anda yakin ingin menghapus data jenjang ini?
        </p>
        <div class="modal-footer justify-content-end" style="border: 0px">
          ...
          <button
            ...
            type="button"
            :disabled="loading"
            @click.prevent="deleteData('jenjang')"
          >
