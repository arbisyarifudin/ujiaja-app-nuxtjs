            ...
            <div class="col-md-12 buat-soal mt-4">
              ...
              <client-only>
                ...
                <div class="d-flex justify-content-end">
                  <button class="btn btn-primary btn-sm square btn-add-mathjax" @click="addMathJax('panduan_pengerjaan')">Add MathJax</button>
                </div>
              </client-only>
                          ...
                          <div class="card-body-content-dua" :key="'B' + b">
                            <div class="col-md-12 dashboard soal mt-2">
                              ...
                              {{'penjelasan_pertanyaan-'  + soalp.id + '-' + b}}
                                <VueEditor
                                  :id="'penjelasan_pertanyaan-' + soalp.id + '-' + b"
                                ...
                                />
                                <div class="d-flex justify-content-end">
                                  <button class="btn btn-primary btn-sm square btn-add-mathjax" @click="addMathJax('penjelasan_pertanyaan-'  + soalp.id + '-' + b)">Add MathJax</button>
                                </div>
                              <UISaveStatus
                                :data="onSubmit.pertanyaan[soalp.id]"
                                v-if="onSubmit.pertanyaan[soalp.id]"
