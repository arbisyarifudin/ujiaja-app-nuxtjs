                      ...
                      <div class="card-body-content">
                        ...
                        >
                          <div class="form-group reg-siswa">
                            ...
                            >
                              <option :value="null">Mata Pelajaran</option>
                        ...
                        <!-- SOAL PERTANYAAN -->
                        <template v-for="(soalp, b) in soal.soal_pertanyaan">
                          <div class="card-body-content-dua" :key="'B' + b">
                                ...
                                >
                                  ...
                                  <div class="input-group-prepend">
                                    <button
                                      ...
                                      @click.prevent="
                                        deleteOption(soalp.opsi_pertanyaan, c)
                                      "
                                    >
                                ...
                                >
                                  ...
                                  <div class="input-group-prepend">
                                    <button
                                      ...
                                      class="btn btn-danger"
                                      @click.prevent="
                                        deleteOption(child.opsi_pertanyaan, c)
                                      "
                                    >
                                      <i class="fa fa-times"></i>
                                    </button>
                            ...
                            <div class="dashboard soal pt-0">
                              <button
                                ...
                                @click.prevent="
                                  addBabMapel(soal.soal_pertanyaan)
                                "
                              >
...
export default {
  ...
  methods: {
    ...
    addOption(soalp) {
      soalp.opsi_pertanyaan.push({ option: "haha", correct: false });
    },
    ...
    addQuestion(soalp) {
      ...
      soalp.pertanyaan_child.push({
        ...
        pembahasan_pertanyaan: "asaasasas",
        parent_soal_pertanyaan: soalp.id,
        pertanyaan_child: []
      });
    },
    addBabMapel(soalp) {
      soalp.push({
        bab_mapel: ["Bab 3", "Bab 4"],
        penjelasan_pertanyaan: "penjelasan pertanyaan ..",
        template_pertanyaan: "Pilihan Ganda",
        soal: "Soal 2",
        gambar: null,
