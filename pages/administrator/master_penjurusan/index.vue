  ...
  <div class="container-fluid crud">
    <div class="row d-flex no-gutters">
      <div class="col-md-12 dashboard px-0">
        <h2 class="dash-label">Penjurusan</h2>
        <p>
          Data ini berisi bidang pada suatu jenjang sekolah. Data ini merupakan
          data master yang dibutuhkan untuk transaksi data siswa.
        </p>
      </div>
                  ...
                  <td>
                    {{
                      item.kelas && item.kelas.jenjang
                        ? item.kelas.jenjang.nama_jenjang
                        : "?"
                    }}
                  </td>
                  <td>{{ item.nama_penjurusan }}</td>
                  <td class="btn-table">
                    <nuxt-link
    ...
    >
      <div>
        <p class="modal-text">
          Apakah anda yakin ingin menghapus penjurusan ini?
        </p>
        <div class="modal-footer justify-content-end" style="border: 0px">
          ...
          <button
            ...
            type="button"
            :disabled="loading"
            @click.prevent="deleteData('penjurusan')"
          >
